...
t.station_to as train_destination, s1.station_code as passenger_source,
s2.station_code as passenger_destination, s1.arrival as source_arrival, s1.departure as passenger_departure,
...
s1.station_sequence < s2.station_sequence`,
    ...
    console.log(ticketdata.rows[0]);
    await client.query("COMMIT");
    return { booked_details: bookingData, ticket_details: ticketdata.rows[0] };
  } catch (err) {
